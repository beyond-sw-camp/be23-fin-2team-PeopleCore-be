...
> 도메인별 상세 설계와 트러블슈팅은 아래 details 섹션 및 [8. 트러블 슈팅](#8-트러블-슈팅) 에서 확인할 수 있습니다.
...
| 영역 | 문서 | 핵심 내용 |
|------|------|-----------|
| 통합검색 | [Elasticsearch](docs/elasticsearch.md) | `unified_search` 인덱스 설계 · Nori/n-gram 분석기 · BM25+kNN 하이브리드(RRF) · Debezium CDC 색인 · 멀티테넌트/권한 필터 |
| AI Copilot | [AI Copilot](docs/ai-copilot.md) | 민감도 분류 → Anthropic / 사내 sLLM(EXAONE) 이중 라우팅 · Tool-Use 루프 · Prompt Caching(input -79%) · 응답 인용·액션 스키마 |
