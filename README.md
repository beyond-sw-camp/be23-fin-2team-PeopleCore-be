...
> 사원관리와 성과 모듈을 담당했습니다. 특히 성과 평가 도메인은 프로젝트 시작 전까지 전혀 알지 못했던 영역이었습니다. 평가 시즌 구조, KPI 지표 설계, 평가자 맵핑 등 도메인을 이해하는 것부터가 쉽지 않았지만, 그만큼 더 파고들며 공부했고 결국 완성도 있게 구현해냈습니다. 모르는 것을 모른다고 인정하고 끝까지 해내는 과정에서 기술적인 성장뿐 아니라 스스로에 대한 자신감도 얻을 수 있었던 프로젝트였습니다.
...
> 급여와 캘린더 모듈을 담당했습니다. 급여 도메인은 세율과 관련 법규를 정확히 준수해야 하는 영역인 만큼, 기능 구현 이전에 법적 기준을 제대로 이해하는 데 많은 시간을 쏟았습니다. 그 과정에서 고민의 깊이가 곧 코드의 품질로 이어진다는 것을 느꼈고, 외부 기술을 덧붙이기보다 상태 패턴 같은 설계 원칙으로 코드 자체의 완성도를 높이는 방향을 선택했습니다. 도메인 지식을 갖춘 개발자로서 그것을 좋은 코드로 표현하는 것이 무엇인지 깊이 고민할 수 있었던 프로젝트였습니다.
