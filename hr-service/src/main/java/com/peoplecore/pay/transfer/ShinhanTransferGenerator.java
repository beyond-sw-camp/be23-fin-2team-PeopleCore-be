...
public class ShinhanTransferGenerator implements BankTransferFileGenerator {
    ...
    public byte[] generate(List<PayrollTransferDto> transfer, String payYearMonth) throws IOException {
        return builder.build(transfer, "신한은행", payYearMonth, List.of(
                ...
                new ExcelTransferBuilder.Column.Text("통장기재내용", PayrollTransferDto::getMemo)
        ));
    }
}
