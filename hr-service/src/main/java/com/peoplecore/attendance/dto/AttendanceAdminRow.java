 ...
 * 역할:
 *  - Employee + Department + Grade + WorkGroup + 오늘 CommuteRecord 를 JOIN 으로 한 번에 가져온 뒤
...
public class AttendanceAdminRow {
    ...
    /** 오늘 출퇴근 레코드 PK (미출근 시 null — 이 값으로 체크인 여부 판정) */
    ...
    /** 체크인 IP — OFFSITE 카드 drilldown detail 표시용 */
