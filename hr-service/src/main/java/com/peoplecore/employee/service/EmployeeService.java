...
//        사번생성: ex. YYYYMM-0001
        ...
        long count = employeeRepository.countByCompanyIdAndEmpNumStartingWith(companyId,prefix);
        String empNum = String.format("%s-%04d",prefix,count+1);
        if(employeeRepository.existsByCompany_CompanyIdAndEmpNum(companyId,empNum)){
